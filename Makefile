...
#    Updated: 2025/04/23 04:43:47 by chlimous         ###   ########.fr        #
#									       #
# **************************************************************************** #
...
SRCS += $(addprefix mem/, ft_bzero.c ft_calloc.c ft_memccpy.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memmove.c ft_memset.c)
...
SRCS += $(addprefix str/, ft_free_strs.c ft_free_strs_array.c ft_split.c ft_str_realloc.c ft_strchr.c ft_strcmp.c ft_strcpy.c ft_strdup.c ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlcpy.c ft_strlen.c ft_strmapi.c ft_strncmp.c ft_strncpy.c ft_strndup.c ft_strnstr.c ft_strrchr.c ft_strslen.c ft_strtrim.c ft_substr.c ft_wcslen.c)
SRCS += $(addprefix array/, ft_rev_int_array.c)
