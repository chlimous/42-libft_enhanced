...
#    Updated: 2025/04/20 19:58:15 by chlimous         ###   ########.fr        #
#									       #
# **************************************************************************** #
...
SRCS += $(addprefix str/, ft_free_strs.c ft_split.c ft_str_realloc.c ft_strchr.c ft_strcpy.c ft_strdup.c ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlcpy.c ft_strlen.c ft_strmapi.c ft_strncmp.c ft_strnstr.c ft_strrchr.c ft_strtrim.c ft_substr.c ft_strncpy.c ft_strndup.c ft_strcmp.c ft_wcslen.c)
